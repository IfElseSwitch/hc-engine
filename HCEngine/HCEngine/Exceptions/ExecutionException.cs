namespace HCEngine
{
    ...
    public abstract class ExecutionException : HCEngineException
    {
        ...
        public ExecutionException(string errorType, string lineOfCode, int line, int column, string description)
        ...
        /// <param name="description">Description of the error</param>
        public ExecutionException(string errorType, ISourceReader reader, string description)
